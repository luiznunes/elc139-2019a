...
#SBATCH -J fractalomp           # job name
#SBATCH -o fractalomp%j.out     # output file name (%j expands to jobID), this file captures standered output from the shell
#SBATCH -e fractalomp%j.err     # error file name (%j expands to jobID), this file captures errors generated from the program
...
do
  ...
  srun ./out/fractalpar1 $nthread $chunk 2000
done